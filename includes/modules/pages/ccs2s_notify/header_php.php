...
// 修改: 如果 ccs2s 返回为成功, 但是 easyshop 不是成功，重新捕获
if ($_POST['trans_type'] == 'authorization' 
	&& $_POST['status'] == '1' 
	&& !in_array($orderInfo['order_status_id'], array('3', '6', '7'))) {
	// capture 交易请款
	$captureData = array(
	...
	// 添加: 判断 ccs2s 结果是否成功, 成功改变订单状态
	if ($captureResult['status'] == '1'){
