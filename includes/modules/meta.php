...
switch ($current_page) {
	...
	break;
	case FILENAME_INDEX:
		$metaInfo['title'] = (IS_ZP == '0') ? HEAD_DEFAULT_TITLE : FASHION_TASTE_CHOICE;
...
if (!isset($metaInfo['title'])||!not_null($metaInfo['title'])) $metaInfo['title'] = (IS_ZP == '0') ? HEAD_DEFAULT_TITLE : FASHION_TASTE_CHOICE;
