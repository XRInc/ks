...
<div class="step" id="checkout-step-shipping">
	<ul class="form-list">
		...
		<li class="wide">
            ...
            <div class="input-box">
                <select onchange="newAddress('shipping');" id="shipping-address-select" name="shipping[address_id]">
        ...
        <ul>
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text required-entry" value="<?php echo isset($shipping['firstname'])?$shipping['firstname']:''; ?>" name="shipping[firstname]" id="shipping-firstname" />
					</div>
				</div>
				<div class="field">
					<label class="required" for="shipping-lastname"><em>*</em><?php echo __('Last Name'); ?></label>
					<div class="input-box">
						<input type="text" class="input-text required-entry" value="<?php echo isset($shipping['lastname'])?$shipping['lastname']:''; ?>" name="shipping[lastname]" id="shipping-lastname" />
					</div>
				</div>
			</li>
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text" value="<?php echo isset($shipping['company'])?$shipping['company']:''; ?>" name="shipping[company]" id="shipping-company" />
					</div>
				</div>
			</li>
			<li class="wide">
				...
				<div class="input-box">
					<input type="text" class="input-text required-entry" value="<?php echo isset($shipping['street_address'])?$shipping['street_address']:''; ?>" name="shipping[street_address]" id="shipping-street_address" />
				</div>
			</li>
			<li class="wide">
				<div class="input-box">
					<input type="text" class="input-text" value="<?php echo isset($shipping['suburb'])?$shipping['suburb']:''; ?>" name="shipping[suburb]" id="shipping-suburb" />
					</div>
				</li>
				<li class="fields">
					<div class="field">
						<label class="required" for="shipping-city"><em>*</em><?php echo __('City'); ?></label>
	 					<div class="input-box">
							<input type="text" class="input-text required-entry" value="<?php echo isset($shipping['city'])?$shipping['city']:''; ?>" name="shipping[city]" id="shipping-city" />
					</div>
				</div>
				<div class="field">
					<label class="required" for="shipping-region"><em id="shipping-region-em"></em><?php echo __('State/Province'); ?></label>
					<div class="input-box">
						<select class="required-entry" name="shipping[region_id]" id="shipping-region_id">
							<option value=""><?php echo __('Please select region, state or province'); ?></option>
						</select>
						<input type="text" class="input-text" value="<?php echo isset($shipping['region'])?$shipping['region']:''; ?>" name="shipping[region]" id="shipping-region" />
					</div>
				</div>
			</li>
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text required-entry" value="<?php echo isset($shipping['postcode'])?$shipping['postcode']:''; ?>" name="shipping[postcode]" id="shipping-postcode" />
					</div>
				</div>
				<div class="field">
					...
					<div class="input-box">
						...
						<select class="required-entry" onchange="updateRegion('shipping');" name="shipping[country_id]" id="shipping-country_id">
			...
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text required-entry" value="<?php echo isset($shipping['telephone'])?$shipping['telephone']:''; ?>" name="shipping[telephone]" id="shipping-telephone" />
					</div>
				</div>
				<div class="field">
					<label for="shipping-fax"><?php echo __('Fax'); ?></label>
					<div class="input-box">
						<input type="text" class="input-text" value="<?php echo isset($shipping['fax'])?$shipping['fax']:''; ?>" name="shipping[fax]" id="shipping-fax" />
					</div>
				</div>
			</li>
		</ul>
