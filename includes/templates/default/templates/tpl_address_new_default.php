		...
		<ul class="form-list">
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text required-entry" value="<?php echo isset($address['firstname'])?$address['firstname']:''; ?>" name="address[firstname]" id="address-firstname" />
					</div>
				</div>
				<div class="field">
					<label class="required" for="address-lastname"><em>*</em><?php echo __('Last Name'); ?></label>
					<div class="input-box">
						<input type="text" class="input-text required-entry" value="<?php echo isset($address['lastname'])?$address['lastname']:''; ?>" name="address[lastname]" id="address-lastname" />
					</div>
				</div>
			</li>
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text" value="<?php echo isset($address['company'])?$address['company']:''; ?>" name="address[company]" id="address-company" />
					</div>
				</div>
			</li>
			<li class="wide">
				...
				<div class="input-box">
					<input type="text" class="input-text required-entry" value="<?php echo isset($address['street_address'])?$address['street_address']:''; ?>" name="address[street_address]" id="address-street_address" />
				</div>
			</li>
			<li class="wide">
				<div class="input-box">
					<input type="text" class="input-text" value="<?php echo isset($address['suburb'])?$address['suburb']:''; ?>" name="address[suburb]" id="address-suburb" />
				</div>
			</li>
			<li class="fields">
				<div class="field">
					<label class="required" for="address-city"><em>*</em><?php echo __('City'); ?></label>
 					<div class="input-box">
						<input type="text" class="input-text required-entry" value="<?php echo isset($address['city'])?$address['city']:''; ?>" name="address[city]" id="address-city" />
					</div>
				</div>
				<div class="field">
					...
					<div class="input-box">
						...
						<input type="text" class="input-text" value="<?php echo isset($address['region'])?$address['region']:''; ?>" name="address[region]" id="address-region" />
					</div>
				</div>
			</li>
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text required-entry" value="<?php echo isset($address['postcode'])?$address['postcode']:''; ?>" name="address[postcode]" id="address-postcode" />
					</div>
				</div>
				<div class="field">
			...
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text required-entry" value="<?php echo isset($address['telephone'])?$address['telephone']:''; ?>" name="address[telephone]" id="address-telephone" />
					</div>
				</div>
				<div class="field">
					<label for="address-fax"><?php echo __('Fax'); ?></label>
					<div class="input-box">
						<input type="text" class="input-text" value="<?php echo isset($address['fax'])?$address['fax']:''; ?>" name="address[fax]" id="address-fax" />
					</div>
				</div>
			</li>
			<li class="control">
