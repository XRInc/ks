...
<div class="step" id="checkout-step-billing">
	<ul class="form-list">
		...
		<li class="wide">
            ...
            <div class="input-box">
                <select onchange="newAddress('billing');" id="billing-address-select" name="billing[address_id]">
        ...
        <ul>
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text required-entry" value="<?php echo isset($billing['firstname'])?$billing['firstname']:''; ?>" name="billing[firstname]" id="billing-firstname" />
					</div>
				</div>
				<div class="field">
					<label class="required" for="billing-lastname"><em>*</em><?php echo __('Last Name'); ?></label>
					<div class="input-box">
						<input type="text" class="input-text required-entry" value="<?php echo isset($billing['lastname'])?$billing['lastname']:''; ?>" name="billing[lastname]" id="billing-lastname" />
					</div>
				</div>
			</li>
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text" value="<?php echo isset($billing['company'])?$billing['company']:''; ?>" name="billing[company]" id="billing-company" />
					</div>
				</div>
				<?php if (!isset($_SESSION['customer_id'])) { ?>
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text required-entry validate-email" value="<?php echo isset($billing['email_address'])?$billing['email_address']:''; ?>" name="billing[email_address]" id="billing-email_address" />
					</div>
				</div>
				<?php } ?>
			</li>
			<li class="wide">
				...
				<div class="input-box">
					<input type="text" class="input-text required-entry" value="<?php echo isset($billing['street_address'])?$billing['street_address']:''; ?>" name="billing[street_address]" id="billing-street_address" />
				</div>
			</li>
			<li class="wide">
				<div class="input-box">
					<input type="text" class="input-text" value="<?php echo isset($billing['suburb'])?$billing['suburb']:''; ?>" name="billing[suburb]" id="billing-suburb" />
					</div>
				</li>
				<li class="fields">
					<div class="field">
						<label class="required" for="billing-city"><em>*</em><?php echo __('City'); ?></label>
	 					<div class="input-box">
							<input type="text" class="input-text required-entry" value="<?php echo isset($billing['city'])?$billing['city']:''; ?>" name="billing[city]" id="billing-city" />
					</div>
				</div>
				<div class="field">
					<label class="required" for="billing-region"><em id="billing-region-em"></em><?php echo __('State/Province'); ?></label>
					<div class="input-box">
						<select class="required-entry" name="billing[region_id]" id="billing-region_id">
							<option value=""><?php echo __('Please select region, state or province'); ?></option>
						</select>
						<input type="text" class="input-text" value="<?php echo isset($billing['region'])?$billing['region']:''; ?>" name="billing[region]" id="billing-region" />
					</div>
				</div>
			</li>
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text required-entry" value="<?php echo isset($billing['postcode'])?$billing['postcode']:''; ?>" name="billing[postcode]" id="billing-postcode" />
					</div>
				</div>
				<div class="field">
					...
					<div class="input-box">
						...
						<select class="required-entry" onchange="updateRegion('billing');" name="billing[country_id]" id="billing-country_id">
			...
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="input-text required-entry" value="<?php echo isset($billing['telephone'])?$billing['telephone']:''; ?>" name="billing[telephone]" id="billing-telephone" />
					</div>
				</div>
				<div class="field">
					<label for="billing-fax"><?php echo __('Fax'); ?></label>
					<div class="input-box">
						<input type="text" class="input-text" value="<?php echo isset($billing['fax'])?$billing['fax']:''; ?>" name="billing[fax]" id="billing-fax" />
					</div>
				</div>
			</li>
			<?php if (isset($_SESSION['customer_id'])) { ?>
