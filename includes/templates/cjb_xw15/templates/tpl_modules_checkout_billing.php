...
<div class="step" id="checkout-step-billing">
	...
	<div id="billing-new-address-form">
		<div class="form-group">
			...
			<input type="text" class="form-control input-text required-entry" value="<?php echo isset($billing['firstname'])?$billing['firstname']:''; ?>" name="billing[firstname]" id="billing-firstname" />
		</div>
		<div class="form-group">
			<label class="required" for="billing-lastname"><em>*</em><?php echo __('Last Name'); ?></label>
			<input type="text" class="form-control input-text required-entry" value="<?php echo isset($billing['lastname'])?$billing['lastname']:''; ?>" name="billing[lastname]" id="billing-lastname" />
		</div>
		<div class="form-group">
		...
		<?php if (!isset($_SESSION['customer_id'])) { ?>
			<div class="form-group">
				...
				<input type="text" class="form-control input-text required-entry validate-email" value="<?php echo isset($billing['email_address'])?$billing['email_address']:''; ?>" name="billing[email_address]" id="billing-email_address" />
			</div>
		<?php } ?>
		<div class="form-group">
			<label class="required" for="billing-street_address"><em>*</em><?php echo __('Street Address'); ?></label>
			<input type="text" class="form-control input-text required-entry" value="<?php echo isset($billing['street_address'])?$billing['street_address']:''; ?>" name="billing[street_address]" id="billing-street_address" />
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control input-text required-entry" value="<?php echo isset($billing['city'])?$billing['city']:''; ?>" name="billing[city]" id="billing-city" />
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control input-text required-entry" value="<?php echo isset($billing['postcode'])?$billing['postcode']:''; ?>" name="billing[postcode]" id="billing-postcode" />
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control input-text required-entry" value="<?php echo isset($billing['telephone'])?$billing['telephone']:''; ?>" name="billing[telephone]" id="billing-telephone" />
		</div>
		<div class="form-group">
