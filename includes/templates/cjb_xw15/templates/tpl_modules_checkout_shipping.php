...
<div class="step" id="checkout-step-shipping">
	...
	<div id="shipping-new-address-form">
		<div class="form-group">
			...
			<input type="text" class="form-control input-text required-entry" value="<?php echo isset($shipping['firstname'])?$shipping['firstname']:''; ?>" name="shipping[firstname]" id="shipping-firstname" />
		</div>
		<div class="form-group">
			<label class="required" for="shipping-lastname"><em>*</em><?php echo __('Last Name'); ?></label>
			<input type="text" class="form-control input-text required-entry" value="<?php echo isset($shipping['lastname'])?$shipping['lastname']:''; ?>" name="shipping[lastname]" id="shipping-lastname" />
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control input-text required-entry" value="<?php echo isset($shipping['street_address'])?$shipping['street_address']:''; ?>" name="shipping[street_address]" id="shipping-street_address" />
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control input-text required-entry" value="<?php echo isset($shipping['city'])?$shipping['city']:''; ?>" name="shipping[city]" id="shipping-city" />
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control input-text required-entry" value="<?php echo isset($shipping['postcode'])?$shipping['postcode']:''; ?>" name="shipping[postcode]" id="shipping-postcode" />
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control input-text required-entry" value="<?php echo isset($shipping['telephone'])?$shipping['telephone']:''; ?>" name="shipping[telephone]" id="shipping-telephone" />
		</div>
		<div class="form-group">
