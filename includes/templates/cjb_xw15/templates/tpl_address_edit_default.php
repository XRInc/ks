<div class="my-account">
	<div class="account-top">
		<div class="page-title">
			<h1><?php echo __('Edit Address') ?><a class="f-right account-more visible-xs"><i class="iconfont">&#xe609;</i></a></h1>
		</div>
		...
		<form id="form-validate" method="post" action="<?php echo href_link(FILENAME_ADDRESS_EDIT, '', 'SSL'); ?>">
			...
			<div class="row">
				<div class="form-group col-md-6">
					...
					<input type="text" class="form-control input-text required-entry" value="<?php echo $address['firstname']; ?>" name="address[firstname]" id="address-firstname" />
				</div>
				<div class="form-group col-md-6">
					<label class="required" for="address-lastname"><em>*</em><?php echo __('Last Name'); ?></label>
					<input type="text" class="form-control input-text required-entry" value="<?php echo $address['lastname']; ?>" name="address[lastname]" id="address-lastname" />
				</div>
				<div class="form-group col-md-6">
					<label for="address-company"><?php echo __('Company'); ?></label>
					<input type="text" class="form-control input-text" value="<?php echo $address['company']; ?>" name="address[company]" id="address-company" />
				</div>
				<div class="form-group col-md-12">
					<label class="required" for="address-street_address"><em>*</em><?php echo __('Street Address'); ?></label>
					<input type="text" class="form-control input-text required-entry" value="<?php echo $address['street_address']; ?>" name="address[street_address]" id="address-street_address" />
				</div>
				<div class="form-group col-md-12">
					<input type="text" class="form-control input-text" value="<?php echo $address['suburb']; ?>" name="address[suburb]" id="address-suburb" />
				</div>
				<div class="form-group col-md-6">
					<label class="required" for="address-city"><em>*</em><?php echo __('City'); ?></label>
					<input type="text" class="form-control input-text required-entry" value="<?php echo $address['city']; ?>" name="address[city]" id="address-city" />
				</div>
				<div class="form-group col-md-6">
					...
					<input type="text" class="form-control input-text" value="<?php echo $address['region']; ?>" name="address[region]" id="address-region" />
				</div>
				<div class="form-group col-md-6">
					<label class="required" for="address-postcode"><em>*</em><?php echo __('Zip/Postal Code'); ?></label>
					<input type="text" class="form-control input-text required-entry" value="<?php echo $address['postcode']; ?>" name="address[postcode]" id="address-postcode" />
				</div>
				<div class="form-group col-md-6">
				...
				<div class="form-group col-md-6">
					...
					<input type="text" class="form-control input-text required-entry" value="<?php echo $address['telephone']; ?>" name="address[telephone]" id="address-telephone" />
				</div>
				<div class="form-group col-md-6">
					<label for="address-fax"><?php echo __('Fax'); ?></label>
					<input type="text" class="form-control input-text" value="<?php echo $address['fax']; ?>" name="address[fax]" id="address-fax" />
				</div>
			</div>
			<?php if ($_SESSION['customer_billing_address_id'] == $address['address_id']) { ?>
				<p><strong><?php echo __('Default Billing Address'); ?></strong></p>
			<?php } else { ?>
				<div class="checkbox">
			...
			<?php if ($_SESSION['customer_shipping_address_id'] == $address['address_id']) { ?>
				<p><strong><?php echo __('Default Shipping Address'); ?></strong></p>
			<?php } else { ?>
				<div class="checkbox">
