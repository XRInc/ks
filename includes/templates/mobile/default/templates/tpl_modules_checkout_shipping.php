        ...
        <ul>
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="form-control required-entry" value="<?php echo isset($shipping['firstname'])?$shipping['firstname']:''; ?>" name="shipping[firstname]" id="shipping-firstname" />
					</div>
				</div>
				<div class="field">
					<label class="required" for="shipping-lastname"><em>*</em><?php echo __('Last Name'); ?></label>
					<div class="input-box">
						<input type="text" class="form-control required-entry" value="<?php echo isset($shipping['lastname'])?$shipping['lastname']:''; ?>" name="shipping[lastname]" id="shipping-lastname" />
					</div>
				</div>
			</li>
			<li class="fields">
			...
			<li class="wide">
				...
				<div class="input-box">
					<input type="text" class="form-control required-entry" value="<?php echo isset($shipping['street_address'])?$shipping['street_address']:''; ?>" name="shipping[street_address]" id="shipping-street_address" />
				</div>
			</li>
			<li class="wide">
				<div class="input-box">
				...
				<li class="fields">
					<div class="field">
						<label class="required" for="shipping-city"><em>*</em><?php echo __('City'); ?></label>
	 					<div class="input-box">
							<input type="text" class="form-control required-entry" value="<?php echo isset($shipping['city'])?$shipping['city']:''; ?>" name="shipping[city]" id="shipping-city" />
					</div>
				</div>
				<div class="field">
			...
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="form-control required-entry" value="<?php echo isset($shipping['postcode'])?$shipping['postcode']:''; ?>" name="shipping[postcode]" id="shipping-postcode" />
					</div>
				</div>
				<div class="field">
			...
			<li class="fields">
				<div class="field">
					...
					<div class="input-box">
						<input type="text" class="form-control required-entry" value="<?php echo isset($shipping['telephone'])?$shipping['telephone']:''; ?>" name="shipping[telephone]" id="shipping-telephone" />
					</div>
				</div>
				<div class="field">
